...
class NaverApi:
    ...
    def get_gungu_info(self, sido_code):
    ...
    def get_dong_info(self, gungu_code):
    ...
    def get_apt_list(self, dong_code):
    ...
    def get_apt_info(self, apt_code, authorization):
    ...
    def get_apt_price(self, apt_code, pyeong_num, trade_type, price_order, authorization):
